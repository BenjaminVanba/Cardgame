...
public class Main extends ApplicationAdapter {
    ...
    private void createMainMenu() {
        ...
        // Centrer le menu
        menuWindow.pack();
        menuWindow.setPosition(MathUtils.roundPositive(stage.getWidth() / 2f - menuWindow.getWidth() / 2f),
                MathUtils.roundPositive(stage.getHeight() / 2f - menuWindow.getHeight() / 2f));
    }
    ...
    private void showOptions() {
        ...
        volumeSlider.setValue(music.getVolume()); // Définir la valeur initiale du slider à la valeur actuelle du volume
        ...
        optionsWindow.pack();
        optionsWindow.setPosition(MathUtils.roundPositive(stage.getWidth() / 2f - optionsWindow.getWidth() / 2f),
                MathUtils.roundPositive(stage.getHeight() / 2f - optionsWindow.getHeight() / 2f));
    ...
    public void render() {
        ...
        float scale = Math.max(Gdx.graphics.getWidth() / backgroundWidth, Gdx.graphics.getHeight() / backgroundHeight);
